    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addr', models.ForeignKey(on_delete=None, to='users.Address', verbose_name='收货地址')),
                ('passport', models.ForeignKey(on_delete=None, to='users.Passport', verbose_name='下单账户')),
            ],
            options={
                'db_table': 's_order',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ForeignKey(on_delete=None, to='books.Books', verbose_name='订单商品')),
                ('order', models.ForeignKey(on_delete=None, to='order.Order', verbose_name='所属订单')),
            ],
            options={
